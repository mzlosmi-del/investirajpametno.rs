...
category: "Štednja"
heroImage: "../../assets/blog/rezerva-hero.jpg"
heroImageAlt: "Hitna rezerva za crne dane — zaštitni jastuk od 3 do 6 meseci troškova"
featured: true
tags:
  - "hitna rezerva"
  - "fond za crne dane"
  ...
  - "osnove"
legacyUrls:
  - "/blog/kada-ste-potrosili-100-evra-pomoci/"
howTo:
  name: "Kako izgraditi hitnu rezervu (fond za crne dane)"
  totalTime: "P6M"
  tool: "Štedni račun"
  steps:
    - name: "Izračunaj mesečne troškove"
      text: "Saberi koliko ti tačno treba mesečno da preživiš — stan, hrana, režije, prevoz, obavezni računi. To je osnovica za cilj rezerve."
    - name: "Skupi prvu rezervu (oko 1.000 evra)"
      text: "Pre nego što napadneš dugove ili investiraš, sakupi početni jastuk od oko 1.000 evra koji pokriva većinu malih, neočekivanih troškova."
    - name: "Izgradi punu rezervu (3–6 meseci troškova)"
      text: "Pomnoži mesečne troškove sa tri do šest i to ti je cilj pune rezerve. Gradiš je postepeno, najbolje automatskim trajnim nalogom."
    - name: "Drži je dostupno, sigurno i u evrima"
      text: "Rezervu drži na običnom, dostupnom štednom računu — da je možeš odmah povući, da je sigurna i zaštićena od pada dinara."
faq:
  - q: "Koliko novca treba da imam u hitnoj rezervi?"
    a: "Cilj je 3 do 6 meseci tvojih osnovnih mesečnih troškova. Pre toga sakupi početnu rezervu od oko 1.000 evra kao prvi jastuk. Ako su ti prihodi nestabilni ili si jedini koji privređuje u domaćinstvu, ciljaj bliže gornjoj granici (6 meseci)."
  - q: "Gde da držim hitnu rezervu?"
    a: "Na običnom, lako dostupnom štednom računu — ne u akcijama, kriptu ni bilo čemu što može da padne baš kad ti zatreba. Mora da bude dostupna odmah i sigurna. Mnogi je drže u evrima radi zaštite od pada dinara i inflacije."
  - q: "Da li je bolje prvo otplatiti dug ili napraviti rezervu?"
    a: "Prvo sakupi malu početnu rezervu (oko 1.000 evra), pa onda agresivno napadaj skupe dugove, a tek zatim gradi punu rezervu od 3–6 meseci. Bez ikakve rezerve, prvi nepredviđeni trošak te ionako vraća u nove dugove."
  - q: "Da li je moja štednja u banci osigurana ako banka propadne?"
    a: "Jeste, do zakonskog limita. U Srbiji depozite osigurava Agencija za osiguranje depozita do 50.000 evra po deponentu i banci. Najavljeno je i podizanje tog iznosa u budućnosti, pa zvaničan limit uvek proveri na sajtu Agencije ili Narodne banke Srbije."
  - q: "Da li hitna rezerva treba da donosi prinos?"
    a: "Ne. Posao rezerve je da bude tu kad zatreba, ne da pravi pare. Ako juriš prinos, žrtvuješ dostupnost i sigurnost — a to je ceo smisao rezerve. Prinos tražiš tek sa novcem koji ti ne treba u svakom trenutku."
---
