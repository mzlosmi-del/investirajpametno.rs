...
tags:
  ...
  - "print on demand"
  - "prodaja majica online"
  - "dodatna zarada"
  - "pokretanje biznisa u Srbiji"
legacyUrls:
  - "/blog/kako-zapoceti-biznis-prodaje-majica-preko-interneta/"
howTo:
  name: "Kako pokrenuti biznis prodaje majica preko interneta"
  totalTime: "P7D"
  tool: "Računar, print-on-demand platforma i prodajni kanal"
  steps:
    - name: "Izaberi nišu i publiku"
      text: "Ne prodaješ „majice” nego majice za tačno određenu grupu — navijače, programere, ljubitelje pasa. Uska niša se lakše targetira i jeftinije dolazi do kupaca."
    - name: "Napravi dizajne"
      text: "Smisli ili naruči nekoliko dizajna koji imaju smisla za tu publiku. Kvalitet i originalnost dizajna su ono što razdvaja prodaju od tišine."
    - name: "Poveži print-on-demand platformu"
      text: "Otvori nalog na print-on-demand servisu koji štampa i šalje majice po porudžbini, tako da nemaš magacin ni početni trošak zaliha."
    - name: "Postavi prodajni kanal"
      text: "Okači proizvode na sopstvenu prodavnicu ili marketplace i jasno definiši cene tako da ti ostane marža posle troška izrade i provizije."
    - name: "Uloži u marketing i prati brojke"
      text: "Bez poseta nema prodaje. Testiraj oglase i sadržaj, prati koliko te košta jedan kupac i koliko ti ostane po majici, pa skaliraj ono što radi."
faq:
  - q: "Koliko se realno zaradi od prodaje majica preko interneta?"
    a: "Zavisi od marže i broja prodatih komada. U print-on-demand modelu marža po majici je obično oko 3–6 evra posle troška izrade i provizije platforme. Da bi došao do nekoliko stotina evra mesečno, treba ti redovan priliv kupaca — a to znači marketing, ne samo okačene proizvode."
  - q: "Da li mi treba početni kapital za prodaju majica?"
    a: "U print-on-demand modelu nemaš trošak zaliha jer se majica štampa tek kad neko naruči. Ali budžet za marketing (oglase) je gotovo neizbežan — to je glavni trošak da bi te ljudi uopšte pronašli."
  - q: "Da li moram da registrujem firmu u Srbiji da bih prodavao majice?"
    a: "Ako od toga ostvaruješ redovan prihod, da — najčešće kroz registraciju preduzetnika. Mnogi počnu kao paušalno oporezovani preduzetnici dok je promet ispod zakonskog limita. Za tačan status i poreske obaveze posavetuj se sa knjigovođom i proveri pravila kod Poreske uprave i APR-a."
  - q: "Koji je najveći razlog što ovakvi biznisi propadnu?"
...
![Raspodela cene jedne majice u print-on-demand modelu: izrada, provizija i tvoja marža](../../assets/blog/prodaja-majica-marza.svg)
