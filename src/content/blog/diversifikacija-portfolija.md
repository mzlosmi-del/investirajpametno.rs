...
heroImage: "../../assets/blog/diversifikacija-hero.jpg"
heroImageAlt: "Diversifikacija portfolija — rizik razbacan kroz mnogo korpi umesto jedne"
featured: true
tags:
  - "diversifikacija"
  ...
  - "indeksni fond"
legacyUrls:
  - "/blog/investiraj-pametno-i-gjorde/"
howTo:
  name: "Kako diversifikovati portfolio"
  totalTime: "PT1H"
  tool: "Brokerski nalog"
  steps:
    - name: "Kreni od širokog indeksnog ETF-a"
      text: "Umesto pojedinačnih akcija, kupi ETF koji prati celo tržište — jednim potezom postaješ suvlasnik stotina ili hiljada firmi."
    - name: "Razbacaj kroz regije i sektore"
      text: "Globalni ETF te izlaže firmama širom sveta i u različitim granama, pa ne zavisiš od jedne države ni jedne industrije."
    - name: "Dodaj klasu imovine za stabilnost po potrebi"
      text: "Ako želiš manje trzanja, deo portfolija može biti u sigurnijim, manje volatilnim instrumentima — srazmerno tvom horizontu i toleranciji na rizik."
    - name: "Ne preteruj i uplaćuj redovno"
      text: "Par širokih ETF-ova je dovoljno. Nemoj da gomilaš desetine proizvoda koje ne razumeš; redovne uplate su važnije od broja pozicija."
faq:
  - q: "Šta je diversifikacija portfolija?"
    a: "Diversifikacija je raspoređivanje novca na više različitih ulaganja — firmi, sektora, regija, klasa imovine — tako da propast ili pad jednog ne sruši ceo portfolio. Narodski: ne stavljaš sva jaja u jednu korpu."
  - q: "Koliko akcija ili fondova treba da imam da bih bio diversifikovan?"
    a: "Ne moraš da brojiš akcije — jedan širok indeksni ETF već sadrži stotine ili hiljade firmi. Za većinu ljudi par širokih ETF-ova je sasvim dovoljno. Gomilanje desetina proizvoda ne povećava diversifikaciju, samo pravi haos."
  - q: "Da li me diversifikacija štiti od pada celog tržišta?"
    a: "Ne potpuno. Diversifikacija uklanja rizik vezan za pojedinačnu firmu ili sektor, ali kad padne celo tržište, padaju i široki fondovi. Od toga te ne čuva diversifikacija, nego dug horizont, mirni živci i to što ne ulažeš novac koji ti treba uskoro."
  - q: "Da li je ETF dovoljan za diversifikaciju?"
    a: "Za većinu početnika jeste. Širok indeksni ETF jednim potezom daje izloženost celom tržištu uz niske troškove. Zato je najlakši i najjeftiniji način da budeš diversifikovan bez analiziranja pojedinačnih firmi."
  - q: "Može li se preterati sa diversifikacijom?"
    a: "Može. Ako kupiš 50 različitih proizvoda koje ne razumeš, to nije diversifikacija nego haos sa više koraka — uz veće troškove i nepreglednost. Cilj je pametno razbacati rizik, ne sakupljati pozicije."
---
