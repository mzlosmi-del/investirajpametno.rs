...
heroImageAlt: "Porez na kapitalni dobitak u Srbiji — akcije, ETF i kripto, stopa 15% i obrazac PPDG-3R"
featured: true
tags:
  ...
  - "alati"
howTo:
  name: "Kako podneti poresku prijavu za kapitalni dobitak (PPDG-3R) preko ePoreza"
  totalTime: "PT30M"
  tool: "ePorezi portal + kvalifikovani elektronski sertifikat ili potpis u oblaku"
  steps:
    - name: "Sakupi potvrde o transakcijama"
      text: "Iz svog brokerskog naloga ili sa kripto platforme izvuci potvrde o svakoj kupovini i prodaji: datum, količina, cena i provizija. Bez ovih dokaza ne možeš da dokažeš nabavnu cenu."
    - name: "Preračunaj devizne iznose u dinare"
      text: "Ako si kupovao i prodavao u evrima ili dolarima, svaku cenu preračunaj u dinare po srednjem kursu NBS na dan te transakcije — posebno za dan kupovine, posebno za dan prodaje."
    - name: "Prijavi se na ePorezi"
      text: "Otvori eporezi.purs.gov.rs i prijavi se kvalifikovanim elektronskim sertifikatom ili potpisom u oblaku (ConsentID aplikacija)."
    - name: "Izaberi prijavu PPDG-3R"
      text: "U delu Porezi i doprinosi izaberi obrazac PPDG-3R. Za vrstu prijave biraš 1, a osnov za prijavu je prenos hartija od vrednosti odnosno digitalne imovine."
    - name: "Unesi prodaje i nabavke"
      text: "Za svaku prodaju unesi prodajnu cenu, pa zatim nabavke koje joj odgovaraju (hronološki, dok ne pokriješ sve prodate komade). Sistem sam računa dobitak i porez od 15%."
    - name: "Priloži dokaze, potpiši i podnesi"
      text: "Dodaj potvrde o transakcijama (i eventualno rešenje o ranijem gubitku), potpiši i podnesi prijavu. Poreska uprava ti šalje rešenje koje se plaća u roku od 15 dana."
faq:
  - q: "Koliko je porez na kapitalni dobitak u Srbiji?"
    a: "Stopa je 15% i plaća se samo na ostvarenu dobit — razliku između prodajne i nabavne cene — a ne na celu prodajnu cenu. Ako si prodao bez zarade ili u gubitku, nema poreza, ali prijava i dalje može biti obavezna."
  - q: "Da li moram da prijavim porez i ako sam prodao u gubitku?"
    a: "Da. Kod hartija od vrednosti (akcije, ETF, obveznice) poreska prijava PPDG-3R se podnosi bez obzira na to da li je ostvaren dobitak ili gubitak. Prijava gubitka ti se čak isplati, jer rešenjem o gubitku stičeš pravo da ga u narednih pet godina prebiješ sa budućim dobicima."
  - q: "Plaća li se porez kad menjam jednu kriptovalutu za drugu?"
    a: "Da. Zamena jedne kriptovalute za drugu (na primer Bitcoin za Ethereum) zakon tretira kao prenos digitalne imovine, isto kao da si prodao za novac. Ako je u tom trenutku ostvarena dobit u odnosu na nabavnu cenu, nastaje obaveza poreza na kapitalni dobitak."
  - q: "Koji je rok za prijavu poreza na akcije, a koji za kripto?"
    a: "Za hartije od vrednosti prijava se podnosi dva puta godišnje: za prodaje od januara do juna do 30. jula tekuće godine, a za prodaje od jula do decembra do 30. januara naredne godine. Za digitalnu imovinu (kripto) rok je 120 dana od isteka kvartala u kojem je ostvaren prihod."
  - q: "Šta ako nemam dokaz o nabavnoj ceni kripta?"
    a: "Bez dokaza o nabavnoj ceni rizikuješ da Poreska uprava uzme da je nabavna cena nula dinara, pa bi se ceo iznos koji si dobio prodajom tretirao kao dobit i oporezovao sa 15%. Zato čuvaj svaku potvrdu sa platforme ili menjačnice o kupovini."
  - q: "Da li postoji oslobođenje ako dugo držim akcije?"
    a: "Da. Ako si pravo, udeo ili hartiju od vrednosti imao u vlasništvu neprekidno najmanje deset godina pre prodaje, ne plaća se porez na kapitalni dobitak i ne podnosi se prijava. Za digitalnu imovinu isto pravilo verovatno važi po istom osnovu, ali zvanično mišljenje nadležnih organa po tom pitanju još nije izdato."
  - q: "Plaća li se porez na kapitalni dobitak od državnih obveznica?"
    a: "Ne. Prenos dužničkih hartija od vrednosti čiji je izdavalac Republika Srbija, autonomna pokrajina, jedinica lokalne samouprave ili Narodna banka Srbije ne smatra se kapitalnim dobitkom, pa se na tu razliku ne plaća porez."
---
...
![Formula za porez na kapitalni dobitak: prodajna cena minus nabavna cena, puta 15%, jednako porez — na primeru 50 evra dobiti i 7,5 evra poreza](../../assets/blog/porez-kapitalni-dobitak-formula.svg)
