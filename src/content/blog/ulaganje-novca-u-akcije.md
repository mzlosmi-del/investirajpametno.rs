...
heroImage: "../../assets/blog/akcije-hero.jpg"
heroImageAlt: "Ulaganje u akcije iz Srbije — grafikon rasta i globalne kompanije"
featured: true
tags:
  - "akcije"
  - "kako kupiti akcije"
  ...
  - "ETF"
  - "ulaganje u akcije"
  - "investiranje iz Srbije"
  - "početnici"
legacyUrls:
  - "/blog/ulaganje-novca-u-akcije/"
howTo:
  name: "Kako iz Srbije kupiti akcije i ETF-ove"
  totalTime: "PT30M"
  tool: "Internet, lična karta, bankovni račun"
  steps:
    - name: "Izaberi regulisanog brokera"
      text: "Izaberi brokersku platformu koja prima klijente iz Srbije i regulisana je kod ozbiljnog nadzornog tela (npr. u EU). Uporedi provizije, ponudu berzi i lakoću korišćenja."
    - name: "Otvori i verifikuj nalog"
      text: "Otvaranje je onlajn. Pripremi ličnu kartu ili pasoš i dokaz adrese. Verifikacija (KYC) traje od par minuta do par dana."
    - name: "Uplati novac"
      text: "Prebaci novac na brokerski nalog bankovnim transferom. Proveri valutu i eventualne troškove konverzije iz dinara."
    - name: "Kupi prvu poziciju"
      text: "Za početak kupi širok indeksni ETF koji prati celo tržište umesto pojedinačne akcije. Time odmah razbacuješ rizik na stotine firmi."
    - name: "Uplaćuj redovno i prijavi porez"
      text: "Nastavi da uplaćuješ svaki mesec bez obzira na cenu. Vodi evidenciju o kupovinama i prodajama jer kapitalni dobitak i dividende podležu prijavi poreza."
faq:
  - q: "Da li mogu da kupujem strane akcije iz Srbije?"
    a: "Možeš. Iz Srbije danas otvaraš nalog kod regulisanog onlajn brokera koji ti daje pristup američkim i evropskim berzama. Treba ti samo internet, lična karta ili pasoš, dokaz adrese i bankovni račun za uplatu."
  - q: "Koliko novca treba da bih počeo da ulažem u akcije?"
    a: "Nema propisanog minimuma — uz frakcione akcije i jeftine ETF-ove možeš da počneš i sa par desetina evra. Mnogo je važnije da uplaćuješ redovno nego koliki ti je prvi ulog."
  - q: "Da li se u Srbiji plaća porez na zaradu od akcija?"
    a: "Da. Na kapitalni dobitak (razliku između prodajne i nabavne cene) plaća se porez od 15%, a porez postoji i na dividende. Ako si akcije držao neprekidno najmanje 10 godina pre prodaje, kapitalni dobitak je oslobođen poreza. Obavezu prijave podnosiš Poreskoj upravi sam."
  - q: "Šta je bolje za početnika — pojedinačne akcije ili ETF?"
    a: "Za većinu početnika ETF je sigurniji početak. Jednim potezom kupuješ udeo u stotinama firmi i razbacuješ rizik, umesto da se kockaš na sudbinu jedne kompanije. Pojedinačne akcije ostavi za kasnije, kad naučiš da čitaš poslovanje firme."
  - q: "Da li je ulaganje u akcije isto što i kockanje?"
    a: "Nije — ali način na koji to radiš može da bude. Dugoročno, diversifikovano ulaganje u produktivne kompanije je investiranje. Jurnjava za 'vrućim' akcijama na osnovu tuđih preporuka je kockanje sa boljim PR-om."
---
