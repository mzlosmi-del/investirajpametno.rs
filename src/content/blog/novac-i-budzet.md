...
category: "Štednja"
heroImage: "../../assets/blog/budzet-hero.jpg"
heroImageAlt: "Kako napraviti kućni budžet — raspodela plate na potrebe, želje i štednju"
featured: true
tags:
  - "budžet"
...
legacyUrls:
  - "/blog/novac-i-budzet/"
howTo:
  name: "Kako napraviti kućni budžet za 30 minuta"
  totalTime: "PT30M"
  tool: "Papir, tabela ili aplikacija za budžet"
  steps:
    - name: "Saberi sve prihode"
      text: "Napiši koliko ti tačno ulazi mesečno — neto plata, honorari, sve. Računaj sa prosekom ako prihod varira."
    - name: "Popiši fiksne troškove"
      text: "Napiši sve troškove koji su svaki mesec isti ili slični: kirija ili rata, režije, telefon, internet, prevoz, krediti."
    - name: "Popiši promenljive troškove"
      text: "Napiši troškove koji variraju: hrana, izlasci, odeća, sitnice, dostava. Ovde se obično krije curenje novca."
    - name: "Oduzmi troškove od prihoda"
      text: "Oduzmi ukupne troškove od prihoda. Ono što ostane je tvoj prostor. Ako je rezultat negativan, sad bar znaš gde je problem."
    - name: "Rasporedi po pravilu 50/30/20"
      text: "Cilj: oko 50% na potrebe, 30% na želje i 20% na štednju i otplatu dugova. Prilagodi procente svojoj realnosti i automatizuj štednju odmah po prijemu plate."
faq:
  - q: "Kako da napravim budžet ako mi prihod varira svakog meseca?"
    a: "Računaj sa prosekom poslednjih nekoliko meseci i to uzmi kao osnovicu — radije malo pesimističnije. U mesecima kad zaradiš više, višak ide u rezervu, a ne u trošak. Tako izravnavaš oscilacije i ne ostaješ kratak u slabijem mesecu."
  - q: "Šta je pravilo 50/30/20?"
    a: "To je jednostavan okvir za raspodelu neto prihoda: oko 50% na potrebe (stan, hrana, režije, prevoz), 30% na želje (izlasci, hobi) i 20% na štednju i otplatu dugova. Nije sveto pismo — prilagodi procente sebi, ali zadrži logiku da štednja ima fiksno mesto."
  - q: "Koja je najbolja aplikacija za budžet?"
    a: "Najbolja je ona koju ćeš zaista koristiti. Za većinu ljudi dovoljna je obična tabela (Excel ili Google Sheets) ili čak papir. Aplikacija pomaže ako automatski povlači transakcije, ali alat nije presudan — navika jeste."
  - q: "Štedim na kraju meseca onoliko koliko ostane — je li to dovoljno?"
    a: "Najčešće nije, jer na kraju meseca obično ne ostane ništa. Okreni redosled: čim ti uđe plata, odvoji štednju prvu (princip 'plati prvo sebi'), pa tek onda troši ostatak. Tako štednja prestaje da bude slučajna."
  - q: "Stvarno nemam od čega da štedim — šta onda?"
    a: "U većini slučajeva problem nije u prihodu nego u tome što ne znaš kuda novac odlazi. Napravi budžet i mesec dana beleži svaki trošak — skoro uvek se pojavi prostor. Ako i posle toga budžet ne sastavlja kraj s krajem, problem je realan i rešava se na strani prihoda ili velikih fiksnih troškova, ne sitnim odricanjem."
---
...
![Kako napraviti kućni budžet — raspodela neto plate po pravilu 50/30/20 na potrebe, želje i štednju](../../assets/blog/budzet-dijagram.svg)
