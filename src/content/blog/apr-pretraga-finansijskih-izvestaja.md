...
category: "Alati"
heroImage: "../../assets/blog/apr-hero.jpg"
heroImageAlt: "APR pretraga finansijskih izveštaja firme — finansijski izveštaj sa rastućim prihodima i lupom"
featured: true
tags:
  - "APR"
  - "pretraga finansijskih izveštaja"
  - "finansijski izveštaj firme"
  - "provera firme"
  - "matični broj"
  - "PIB"
  - "analiza domaćih firmi"
  - "alati"
legacyUrls:
  - "/blog/apr-pretraga-finansijskih-izvestaja/"
howTo:
  name: "Kako proveriti finansijski izveštaj firme na APR-u"
  totalTime: "PT5M"
  tool: "Internet pregledač"
  steps:
    - name: "Otvori javnu pretragu finansijskih izveštaja"
      text: "Idi na fin.apr.gov.rs/JavnaPretraga — Javna pretraga evidencije obveznika finansijskih izveštaja. Nije potrebna registracija ni prijava."
    - name: "Ukucaj firmu"
      text: "Pretraži firmu po nazivu, matičnom broju ili PIB-u. Matični broj i PIB su precizniji jer izbegavaš firme sa sličnim imenom."
    - name: "Izaberi tip izveštaja i godinu"
      text: "Izaberi vrstu izveštaja (redovan, konsolidovani ili vanredni) i izveštajnu godinu. Otvori i ranije godine da vidiš trend, ne samo poslednju."
    - name: "Otvori i pročitaj izveštaj"
      text: "Otvori objavljeni finansijski izveštaj i pogledaj rezultat (dobitak ili gubitak), obaveze, kretanje prihoda, likvidnost i da li firma uredno predaje izveštaje."
faq:
  - q: "Da li je APR pretraga finansijskih izveštaja besplatna?"
    a: "Jeste. Javna pretraga objavljenih finansijskih izveštaja na APR-u je potpuno besplatna i ne zahteva registraciju. Pristupaš joj sa telefona ili kompjutera preko internet pregledača, na adresi fin.apr.gov.rs/JavnaPretraga."
  - q: "Kako da pronađem firmu na APR-u ako ne znam matični broj?"
    a: "Možeš da pretražuješ i po nazivu firme. Problem je što više firmi može imati slično ime, pa lako otvoriš pogrešnu. Najpouzdanije je pretraživati po matičnom broju (8 cifara) ili PIB-u (9 cifara) — te brojeve obično nađeš na profakturi, ugovoru, sajtu firme ili u njihovom memorandumu."
  - q: "Koliko godina unazad mogu da vidim izveštaje?"
    a: "Preko javne pretrage redovno su dostupni objavljeni finansijski izveštaji za poslednjih nekoliko izveštajnih godina. To je dovoljno da uhvatiš trend — a trend kroz 3–5 godina ti govori mnogo više od jedne jedine godine."
  - q: "Šta ako firma uopšte nije predala finansijski izveštaj?"
    a: "To je samo po sebi crvena zastavica. Aktivna firma koja posluje uredno predaje izveštaje na vreme. Ako izveštaja nema, ako kasne ili ih ima sa rupama u godinama, postavi pitanje pre nego što uložiš novac ili potpišeš ozbiljan ugovor."
  - q: "Da li podaci sa APR-a važe kao zvaničan dokument?"
    a: "Podaci iz javne pretrage imaju prvenstveno informativni karakter i odlični su za brzu proveru. Ako ti treba zvaničan izvod ili potvrda sa pravnom snagom (za banku, sud, tender), to se zasebno traži od APR-a uz odgovarajuću naknadu."
  - q: "Mogu li preko APR-a da proverim preduzetnika (paušalca), a ne samo firmu (d.o.o.)?"
    a: "Možeš da proveriš sve obveznike koji predaju finansijske izveštaje. Deo preduzetnika koji vode poslovne knjige predaje izveštaje, dok paušalno oporezovani preduzetnici uglavnom nemaju iste obaveze izveštavanja, pa za njih nećeš naći klasičan bilans. Tada se oslanjaš na druge provere — registar privrednih subjekata, reference i ugovor."
---
...
![APR pretraga finansijskih izveštaja — tok od naziva firme, preko izbora godine i tipa izveštaja, do čitanja brojki](../../assets/blog/apr-pretraga.svg)
