...
category: "Alati"
heroImage: "../../assets/blog/ekatastar-hero.jpg"
heroImageAlt: "Stan u Beogradu — provera vlasništva preko eKatastra"
featured: true
tags:
  - "eKatastar"
  - "RGZ"
  ...
  - "alati"
howTo:
  name: "Kako proveriti vlasnika nekretnine preko eKatastra"
  totalTime: "PT2M"
  tool: "Internet pregledač"
  steps:
    - name: "Otvori javni pristup eKatastru"
      text: "Idi na katastar.rgz.gov.rs/eKatastarPublic/ ili na sajtu RGZ-a izaberi opciju Javni pristup. Nije potrebna registracija."
    - name: "Izaberi tip pretrage"
      text: "Izaberi pretragu po adresi ako tražiš stan ili kuću, ili po broju parcele ako tražiš zemljište."
    - name: "Ukucaj lokaciju"
      text: "Ukucaj opštinu, ulicu i kućni broj. Sistem će ti izlistati sve upisane nepokretnosti na toj adresi."
    - name: "Otvori list nepokretnosti"
      text: "Klikni na konkretan stan ili objekat, otvori list nepokretnosti i proveri vlasnika, udeo, površinu i terete."
faq:
  - q: "Da li je eKatastar besplatan?"
    a: "Jeste. Javni pristup eKatastru je potpuno besplatan i ne zahteva registraciju. Pristupaš mu sa bilo kog uređaja preko internet pregledača."
  - q: "Da li mi treba registracija da bih proverio nekretninu?"
    a: "Ne. Za osnovnu proveru — vlasnik, površina, tereti, hipoteke — dovoljan ti je javni pristup. Registracija je potrebna samo ako želiš proširene podatke koje koriste profesionalci (advokati, geodeti, agencije)."
  - q: "Mogu li da pretražim nekretnine po imenu vlasnika?"
    a: "Ne. Po Zakonu o zaštiti podataka ličnosti, pretraga ide u suprotnom smeru — prvo pronađeš nekretninu (po adresi ili broju parcele), pa onda vidiš ko je vlasnik."
  - q: "Da li podaci iz eKatastra važe kao zvaničan dokaz?"
    a: "Ne. Podaci sa javnog pristupa imaju informativni karakter. Ako ti je potreban zvaničan dokument (za sud, banku, kupoprodajni ugovor), potreban ti je overen prepis lista nepokretnosti — to se vadi u nadležnoj službi za katastar ili preko eUprave."
  - q: "Šta ako nekretnina nije u bazi eKatastra?"
...
![eKatastar pretraga — od ukucane adrese do lista nepokretnosti za dva minuta](../../assets/blog/ekatastar-pretraga.svg)
